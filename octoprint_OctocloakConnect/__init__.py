...
class OctocloakconnectPlugin(octoprint.plugin.StartupPlugin,
	...
	def get_update_information(self):
		...
		# for details.
		return dict(
			OctocloakConnect=dict(
				displayName="Octocloakconnect Plugin",
				displayVersion=self._plugin_version,

				# version check: github repository
				type="github_release",
				user="Camphul",
				repo="OctocloakConnect",
				current=self._plugin_version,

				# update method: pip
				pip="https://github.com/Camphul/OctocloakConnect/archive/{target_version}.zip"
			)
		)
...
__plugin_name__ = "Octocloakconnect Plugin"
...
def __plugin_load__():
	...
	__plugin_implementation__ = OctocloakconnectPlugin()
